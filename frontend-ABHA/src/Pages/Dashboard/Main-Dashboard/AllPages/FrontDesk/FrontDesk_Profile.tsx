...
import { UpdateFrontDesk } from "../../../../../Redux/auth/action";
import docimg from "../../../../../img/profile.png";
import "./CSS/Profiles.css";
import styles_doctor from "react-icons/md";
("../Doctor/CSS/Doctor_Profile.module.css");
...
const Nurse_Profile = () => {
  ...
  const handleFormSubmit = () => {
    dispatch(UpdateFrontDesk(formData, user._id));
    console.log(user);
        ...
        <div className={styles_global.AfterSideBar}>
          {
            <div className="maindoctorProfile">
              <div className="firstBox doctorfirstdiv">
                <div>
                  <img src={formData?.image} alt="docimg" />
                </div>
                <hr />
                {
                  <div className="singleitemdiv">
                    <GiMeditation className="singledivicons" />
                    <p>{formData?.nurseName}</p>
                  </div>
                }
                <div className="singleitemdiv">
